...
const SelectboxMenu = memo(
    ({
        ...
        const getOptionRoundedClass = (index, totalCount) => {
            ...
            const classes =
                roundedClasses[nextRounded] || roundedClasses.secondary;
                    ...
                    <div onClick={(e) => e.stopPropagation()}>
                        <Input
                            ...
                            className={CN(
                                "[&>div]:rounded-b-none",
                                nextRounded === "primary" &&
                                    "[&>div]:rounded-t-primary",
                                nextRounded === "secondary" &&
                                    "[&>div]:rounded-t-secondary",
                                nextRounded === "tertiary" &&
                                    "[&>div]:rounded-t-tertiary",
                            )}
                        />
                    </div>
                )}
            ...
            <div className={CN("flex flex-col gap-2", className)}>
                ...
                <div
                    className={CN(
                        ...
                        noBorder &&
                            "!border-0 !border-transparent !bg-base/5 hover:!bg-white/60 dark:hover:!bg-black/40",
                        blurry
                            ? COMPONENT_STYLES.blur.enabled
                            : COMPONENT_STYLES.blur.disabled,
