  ...
  return (
    ...
    >
      <div className="flex items-center h-auto gap-3 animate-pulse">
        <div className="w-[52px] h-[52px] rounded-primary bg-base/5/10" />
        <div className="flex-1 flex flex-col space-y-1 overflow-hidden">
          <div className="h-4 bg-base/5/10 rounded-tertiary w-3/4" />
          <div className="h-3 bg-base/5/10 rounded-tertiary w-1/2 mt-1" />
        </div>
      </div>
    </div>
  );
