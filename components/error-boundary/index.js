            ...
            <div className='bg-error/10 dark:bg-error/20 border-error/30 dark:border-error/40 rounded-primary w-full max-w-md border p-6 text-center'>
              ...
              {this.props.showResetButton && (
                <button
                  ...
                  className='bg-error hover:bg-error/90 dark:bg-error dark:hover:bg-error/90 rounded-secondary px-4 py-2 font-medium text-white transition-colors'
                >
              ...
              {process.env.NODE_ENV === 'development' &&
                this.state.errorInfo && (
                  <details className='mt-4 text-left'>
                    <summary className='text-error hover:text-error/80 dark:hover:text-error/70 cursor-pointer text-sm'>
