...
/**
 * specific API client for handling HTTP requests with interceptors and timeouts.
 */
export class ApiClient {
   ...
   * @param {Function} interceptor - Function to modify config before request
   * @returns {ApiClient}
   */
   ...
   * @param {Function} interceptor - Function to modify response after request
   * @returns {ApiClient}
   */
  ...
  async request(endpoint, options = {}) {
    try {
      ...
      if (error.name === "AbortError") {
        const timeoutError = new ApiError("Request timeout", 408, null, null);
